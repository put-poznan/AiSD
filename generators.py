...
def generate_ascending_sequence(size, min_val=0, max_val=100):
	seq = generate_random_sequence(size, min_val, max_val)
	seq.sort()
	return seq

def generate_descending_sequence(size, min_val=0, max_val=100):
	seq = generate_random_sequence(size, min_val, max_val)
	seq.sort()
	seq.reverse()
	return seq

def generate_v_sequence(size, min_val=0, max_val=100):
